...
**pre-built point cloud map**. The map comes from
[frontier-fw-go2w](../../frontier-fw-go2w) (D-LIO `save_pcd`) or from a
human carrying a LiDAR; it may be incomplete — the stack treats unknown
...
| `nav_goal_go2w_bringup` | top-level launch, static TFs, RViz configs |
